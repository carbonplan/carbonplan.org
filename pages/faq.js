    ...
    <Layout links={'homepage'} title={'faq / carbonplan'} nav={'faq'}>
      ...
      <Box sx={{ mb: [8, 8, 9, 10] }}>
        ...
        <Answer>
          ...
          and more . Note that some technologies can play a role in carbon
          removal but are not, on their own, carbon removal systems — you can
          read more about this distinction in an{' '}
        ...
        <Answer>
          ...
          brand and we have worked collaboratively since on the design system
