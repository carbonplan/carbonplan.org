    ...
    <Layout links={'homepage'} title={'terms / carbonplan'}>
      <Box sx={{ mb: [8, 8, 9, 10] }}>
        ...
        <Row>
          <Column start={[2, 2, 3, 3]} width={[5, 5, 6, 6]}>
            ...
            >
              ...
              state-specific fundraising disclosure statements and/or
              instructions for how to obtain additional information.
            </Box>
            <br />
            <Box
              sx={{
        ...
        <Content>
          ...
          APPROVAL, OR RECOMMENDATION BY THE STATE. Florida Registration
          #CH65294.
        </Content>
        <Label>Georgia</Label>
        <Content>
          A full and fair description of our programs and our financial
          statement summary is available upon request at our office and phone
